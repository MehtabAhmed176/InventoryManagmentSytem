...
namespace InventoryManagment.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            var inventoryDbContext = _context.Users.Include(u => u.UsersBranches);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Username,Password,ConfirmPassword,Role,BranchId")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
